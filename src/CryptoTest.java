...
public class CryptoTest 
{
	public static void main(String[] args) throws Exception {
		...
		// Crypt
		{
			...
			System.out.println("crypted ciphertext (len: "+cipherText.length+") is : " + bytesAsHex(cipherText));
		}
		// Decrypt
		{
			Cipher cipher = Cipher.getInstance("AES/CBC/PKCS5Padding");
			...
			System.out.println("decrypted plaintext (len: "+plainText2.length+") is : " + new String(plainText2));
		}
	}
	//
