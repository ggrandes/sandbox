...
public class CRC64 implements Checksum {
	...
	public static void main(String[] args) {
		...
		System.out.println("0c171b2e54a30c11=" + Long.toHexString(crc.getValue()));
		crc.reset();
		crc.update("hello world".getBytes());
		System.out.println("12511f272d9bc22a=" + Long.toHexString(crc.getValue()));
	}
}
