...
public class PasswordGenerator {
	...
	private final static char[] DEF_ALPHABET = "23456789ABCDEFGHIJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz#$!:.=+-/_".toCharArray();
	...
	public static String genPassword(final int len) {
		...
		while (true) {
			...
			for (int i = 0; i < len;) {
				...
				if ((c >= '0') && (c <= '9')) nums = true;
				else if ((c >= 'a') && (c <= 'z')) minus = true;
				else if ((c >= 'A') && (c <= 'Z')) mayus = true;
				else {
